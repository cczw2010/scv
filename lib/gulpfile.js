...
gulp.task('js', function() {
  var combined = combiner.obj([
      gulp.src(jsWatch),
      changed(tmpSpace+jsPath,{extension: '.js'}),
      jshint(),
      scvconcat({suffix:'js'}),
      uglify({outSourceMap: false}),
      gulp.dest(tmpSpace+jsPath)
    ]);
...
gulp.task('css', function() {
  var combined = combiner.obj([
      gulp.src(cssWatch),
      changed(tmpSpace+cssPath,{extension: '.css'}),
      autofixer({
...
gulp.task('html', function() {
  var combined = combiner.obj([
      gulp.src(htmlWatch),
      changed(tmpSpace+htmlPath,{extension: '.html'}),
      htmlmin({
